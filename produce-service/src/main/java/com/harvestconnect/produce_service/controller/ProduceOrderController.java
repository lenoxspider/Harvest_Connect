...
public class ProduceOrderController {
    ...
    @PostMapping
    public OrderResponse placeOrder(@RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization,
    ...
    @GetMapping("/my")
    public List<OrderResponse> getMyOrders(@RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization) {
